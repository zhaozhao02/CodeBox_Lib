...
static const _ArucoPose_type_support_symbol_names_t _ArucoPose_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, aruco_msgs, msg, ArucoPose)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, aruco_msgs, msg, ArucoPose)),
  }
};
...
get_message_type_support_handle<aruco_msgs::msg::ArucoPose>()
{
  return &::aruco_msgs::msg::rosidl_typesupport_cpp::ArucoPose_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, aruco_msgs, msg, ArucoPose)() {
  return get_message_type_support_handle<aruco_msgs::msg::ArucoPose>();
}
