...
#include "aruco_msgs/msg/detail/aruco_pose__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = aruco_msgs::msg::ArucoPose;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const aruco_msgs::msg::ArucoPose *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<aruco_msgs::msg::ArucoPose *>(
    untyped_ros_message);
...
{
  return &aruco_msgs::msg::typesupport_fastrtps_cpp::_ArucoPose__handle;
}
